...
/**
 * This example implements an echo client using UDP
 */
public class UdpClient {
    ...
    public static void main(String argv[]) {
        ...
        try {
            sDatagram = new DatagramSocket(); // Create a non connection-oriented socket
                                              // (use any available port)
            sDatagram.setSoTimeout(300000);   // Set timeout to 300 secs
